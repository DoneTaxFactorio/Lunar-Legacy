...
local decorative_trigger_effects = require("prototypes.lunaris.decorative.decorative-trigger-effects")
...
data:extend{
  ...
  shroom_decal("lunaris_shroom-decal", {r = 225 / 255, g = 171 / 255, b = 141 / 255}),
  {
  ...
  },
  {
    ...
    minable =
    {
      ...
      {
        {type = "item", name = "stone", amount_min = 24, amount_max = 50},
        {type = "item", name = "lunaris_lunore", amount_min = 24, amount_max = 50}
      },
    },
    map_color = {59, 127, 133},
    count_as_rock_for_filtered_deconstruction = true,
    mined_sound = sounds.deconstruct_bricks(1.0),
    impact_category = "stone",
    render_layer = "object",
