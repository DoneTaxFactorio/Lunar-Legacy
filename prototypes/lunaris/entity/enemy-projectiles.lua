...
data:extend(
{
  ...
  acid_stream({
    name = "lunaris_acid-stream-worm-small",
    scale = scale_worm_small*1.1,
    tint = stream_tint_worm_small,
    corpse_name = "lunaris_acid-splash-worm-small",
    spit_radius = stream_radius_worm_small,
    particle_spawn_interval = 1,
    particle_spawn_timeout = 6,
    splash_fire_name = "lunaris_acid-splash-fire-worm-small",
    sticker_name = "lunaris_acid-sticker-small"
  }),
  acid_stream({
    name = "lunaris_acid-stream-worm-medium",
    scale = scale_worm_medium,
    tint = stream_tint_worm_medium,
    corpse_name = "lunaris_acid-splash-worm-medium",
    spit_radius = stream_radius_worm_medium,
    particle_spawn_interval = 1,
    particle_spawn_timeout = 6,
    splash_fire_name = "lunaris_acid-splash-fire-worm-medium",
    sticker_name = "lunaris_acid-sticker-medium"
  }),
  acid_stream({
    name = "lunaris_acid-stream-worm-big",
    scale = scale_worm_big,
    tint = stream_tint_worm_big,
    corpse_name = "lunaris_acid-splash-worm-big",
    spit_radius = stream_radius_worm_big,
    particle_spawn_interval = 1,
    particle_spawn_timeout = 6,
    splash_fire_name = "lunaris_acid-splash-fire-worm-big",
    sticker_name = "lunaris_acid-sticker-big"
  }),
  acid_stream({
    name = "lunaris_acid-stream-worm-behemoth",
    scale = scale_worm_behemoth,
    tint = stream_tint_worm_behemoth,
    corpse_name = "lunaris_acid-splash-worm-behemoth",
    spit_radius = stream_radius_worm_behemoth,
    particle_spawn_interval = 1,
    particle_spawn_timeout = 6,
    splash_fire_name = "lunaris_acid-splash-fire-worm-behemoth",
    sticker_name = "lunaris_acid-sticker-behemoth"
  }),
  -- S P I T T E R   S T R E A M S --------------------------------------------------------------------------------------------------------
  acid_stream({
    name = "lunaris_acid-stream-spitter-small",
    scale = scale_spitter_small*1.1,
    tint = stream_tint_spitter_small,
    corpse_name = "lunaris_acid-splash-spitter-small",
    spit_radius = stream_radius_spitter_small,
    particle_spawn_interval = 1,
    particle_spawn_timeout = 6,
    splash_fire_name = "lunaris_acid-splash-fire-spitter-small",
    sticker_name = "lunaris_acid-sticker-small"
  }),
  acid_stream({
    name = "lunaris_acid-stream-spitter-medium",
    scale = scale_spitter_medium,
    tint = stream_tint_spitter_medium,
    corpse_name = "lunaris_acid-splash-spitter-medium",
    spit_radius = stream_radius_spitter_medium,
    particle_spawn_interval = 1,
    particle_spawn_timeout = 6,
    splash_fire_name = "lunaris_acid-splash-fire-spitter-medium",
    sticker_name = "lunaris_acid-sticker-medium"
  }),
  acid_stream({
    name = "lunaris_acid-stream-spitter-big",
    scale = scale_spitter_big,
    tint = stream_tint_spitter_big,
    corpse_name = "lunaris_acid-splash-spitter-big",
    spit_radius = stream_radius_spitter_big,
    particle_spawn_interval = 1,
    particle_spawn_timeout = 6,
    splash_fire_name = "lunaris_acid-splash-fire-spitter-big",
    sticker_name = "lunaris_acid-sticker-big"
  }),
  acid_stream({
    name = "lunaris_acid-stream-spitter-behemoth",
    scale = scale_spitter_behemoth,
    tint = stream_tint_spitter_behemoth,
    corpse_name = "lunaris_acid-splash-spitter-behemoth",
    spit_radius = stream_radius_spitter_behemoth,
    particle_spawn_interval = 1,
    particle_spawn_timeout = 6,
    splash_fire_name = "lunaris_acid-splash-fire-spitter-behemoth",
    sticker_name = "lunaris_acid-sticker-behemoth"
  }),

  -- A C I D   S P L A S H   F I R E ------------------------------------------------------------------------------------------------------
  acid_splash_fire({
    name = "lunaris_acid-splash-fire-worm-small",
  ...
  acid_splash_fire({
    name = "lunaris_acid-splash-fire-worm-medium",
    scale = scale_worm_medium,
  ...
  acid_splash_fire({
    name = "lunaris_acid-splash-fire-worm-big",
    scale = scale_worm_big,
  ...
  acid_splash_fire({
    name = "lunaris_acid-splash-fire-worm-behemoth",
    scale = scale_worm_behemoth,
  ...
  ------------------------------------------------------------------
  acid_splash_fire({
    name = "lunaris_acid-splash-fire-spitter-small",
  ...
  acid_splash_fire({
    name = "lunaris_acid-splash-fire-spitter-medium",
    scale = scale_spitter_medium,
  ...
  acid_splash_fire({
    name = "lunaris_acid-splash-fire-spitter-big",
    scale = scale_spitter_big,
  ...
  acid_splash_fire({
    name = "lunaris_acid-splash-fire-spitter-behemoth",
    scale = scale_spitter_behemoth,
  ...
  acid_sticker({
    name = "lunaris_acid-sticker-small",
  ...
  acid_sticker({
    name = "lunaris_acid-sticker-medium",
  ...
  acid_sticker({
    name = "lunaris_acid-sticker-behemoth",
