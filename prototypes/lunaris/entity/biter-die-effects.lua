    ...
    {
      {
        ...
        particle_name = "lunaris_blood-particle-small",
        offsets =
        {
          { 0, 0.5 },
          { 0, 0.6 }
    ...
    {
      {
        ...
        affects_target = false,
        show_in_tooltip = false,
        particle_name = "lunaris_blood-particle",
        offsets =
        {
          { -0.1, -1.2},
          { 0, -0.24 }
  ...
  action_delivery =
  {
    ...
    target_effects =
    {
      ...
      },
      {
        ...
        affects_target = false,
        show_in_tooltip = false,
        particle_name = "lunaris_blood-particle-carpet-small",
        offsets = {
          { 0, 0 }
        },
        offset_deviation = {
  ...
  action_delivery =
  {
    ...
    target_effects =
    {
      ...
      },
      {
        ...
        affects_target = false,
        show_in_tooltip = false,
        particle_name = "lunaris_blood-particle-carpet",
        offsets = {
          { 0, 0 }
        },
        offset_deviation = {
  ...
  action_delivery =
  {
    ...
    target_effects =
    {
      ...
      },
      {
        ...
        affects_target = false,
        show_in_tooltip = false,
        particle_name = "lunaris_blood-particle-lower-layer-small",
        offsets = {
          { 0, 0 }
        },
        offset_deviation = {
  ...
  action_delivery =
  {
    ...
    target_effects =
    {
      ...
      },
      {
        ...
        affects_target = false,
        show_in_tooltip = false,
        particle_name = "lunaris_blood-particle-lower-layer",
        offsets = {
          { 0, 0 }
        },
        offset_deviation = {
