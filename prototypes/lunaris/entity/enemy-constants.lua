...
stream_tint  = { 71, 233, 255 }  -- #47E9FF
splash_tint = { 71, 233, 255 }
...
spitter_spawner_tint = {130, 213, 181}

-- B I T E R S --

small_biter_scale = 0.5 -- 0.5
small_biter_tint1 = {130, 213, 181, 1}
small_biter_tint2 = {204, 178, 132, 0.7}

medium_biter_scale = 0.7
medium_biter_tint1 = {40, 40, 80, 1}
medium_biter_tint2 = {204, 178, 132, 0.7}

big_biter_scale = 1.0
big_biter_tint1 = {215, 128, 97, 1}
big_biter_tint2 = {204, 178, 132, 0.7}

behemoth_biter_scale = 1.2
behemoth_biter_tint1 = {0, 222, 255, 1}
behemoth_biter_tint2 = {204, 178, 132, 0.7}

-- S P I T T E R S --

scale_spitter_small    = 0.5
tint_1_spitter_small    = {130, 213, 181, 1}
tint_2_spitter_small    = {204, 178, 132, 0.7}

scale_spitter_medium   = 0.7
tint_1_spitter_medium   = {40, 40, 80, 1}
tint_2_spitter_medium   = {204, 178, 132, 0.7}

scale_spitter_big      = 1.0
tint_1_spitter_big      = {215, 128, 97, 1}
tint_2_spitter_big      = {204, 178, 132, 0.7}

scale_spitter_behemoth = 1.2
tint_1_spitter_behemoth = {0, 222, 255, 1}
tint_2_spitter_behemoth = {204, 178, 132, 0.7}
