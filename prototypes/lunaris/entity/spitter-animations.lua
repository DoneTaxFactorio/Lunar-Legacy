...
function spitterattackanimation(scale, tint1, tint2)
  return
  {
    layers=
    {
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-attack",
        {
          slice = 6,
          frame_count = 14,
          direction_count = 16,
      ...
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-attack-mask1",
        {
          slice = 6,
          frame_count = 14,
          direction_count = 16,
      ...
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-attack-mask2",
        {
          slice = 6,
          frame_count = 14,
          direction_count = 16,
      ...
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-attack-shadow",
        {
          slice = 6,
          frame_count = 14,
          direction_count = 16,
...
function spitterrunanimation(scale, tint1, tint2)
  return
  {
    layers=
    {
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-run",
        {
          slice = 6,
          frame_count = 16,
          direction_count = 16,
      ...
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-run-mask1",
        {
          slice = 6,
          frame_count = 16,
          direction_count = 16,
      ...
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-run-mask2",
        {
          slice = 6,
          frame_count = 16,
          direction_count = 16,
      ...
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-run-shadow",
        {
          slice = 6,
          frame_count = 16,
          direction_count = 16,
...
function spitterdyinganimation(scale, tint1, tint2)
  return
  {
    layers=
    {
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-die",
        {
          slice = 6,
          frame_count = 15,
          direction_count = 16,
      ...
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-die-mask1",
        {
          slice = 6,
          frame_count = 15,
          direction_count = 16,
      ...
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-die-mask2",
        {
          slice = 6,
          frame_count = 15,
          direction_count = 16,
      ...
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-die-shadow",
        {
          slice = 6,
          frame_count = 15,
          direction_count = 16,
...
function spitter_decay_animation(scale, tint1, tint2)
  return
  {
    ...
    layers=
    {
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-decay",
        {
          slice = 6,
          frame_count = 24,
          direction_count = 16,
      ...
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-decay-mask1",
        {
          slice = 6,
          frame_count = 24,
          direction_count = 16,
      ...
      util.sprite_load("__lunaris_graphics__/graphics/entity/spitter/spitter-decay-mask2",
        {
          slice = 6,
          frame_count = 24,
          direction_count = 16,
...
function add_spitter_die_animation(scale, tint1, tint2, corpse)
  ...
  {
    sheet =
      util.sprite_load("__lunaris_graphics__/graphics/entity/biter/blood-puddle-var-main",
        {
          flags = { "low-object" },
          variation_count = 4,
          scale = scale * 0.5,
...
function spitter_water_reflection(scale)
  return
  {
    pictures =
    {
      filename = "__lunaris_graphics__/graphics/entity/spitter/spitter-reflection.png",
      priority = "extra-high",
      width = 20,
      height = 32,
