...
local biter_ai_settings = require ("prototypes.lunaris.entity.biter-ai-settings")
local sounds = require ("prototypes.lunaris.entity.sounds")
local hit_effects = require ("prototypes.lunaris.entity.hit-effects")
local simulations = require("__base__.prototypes.factoriopedia-simulations")
local enemy_autoplace = require ("prototypes.lunaris.entity.enemy-autoplace-utils")
...
{
  {
    ...
    corpse = "lunaris_small-biter-corpse",
  ...
  {
    type = "corpse",
    name = "lunaris_small-biter-corpse",
...

  {
    ...
    corpse = "lunaris_biter-spawner-corpse",
    ...
    result_units = (function()
                     local res = {}
                     res[1] = {"lunaris_small-biter", {{0.0, 0.3}, {0.6, 0.0}}}
                     if not data.is_demo then
                       -- from evolution_factor 0.3 the weight for medium-biter is linearly rising from 0 to 0.3
                       -- this means for example that when the evolution_factor is 0.45 the probability of spawning
                       -- a small biter is 66% while probability for medium biter is 33%.
                       res[2] = {"lunaris_medium-biter", {{0.2, 0.0}, {0.6, 0.3}, {0.7, 0.1}}}
                       -- for evolution factor of 1 the spawning probabilities are: small-biter 0%, medium-biter 1/8, big-biter 4/8, behemoth biter 3/8
                       res[3] = {"lunaris_big-biter", {{0.5, 0.0}, {1.0, 0.4}}}
                       res[4] = {"lunaris_behemoth-biter", {{0.9, 0.0}, {1.0, 0.3}}}
                     end
                     return res
                   end)(),
    ...
    autoplace = enemy_autoplace.enemy_spawner_autoplace("lunaris_enemy_autoplace_base(0, 7)"),
    ...
    {
      {
        decorative = "lunaris_light-mud-decal",
        spawn_min = 0,
        spawn_max = 2,
        spawn_min_radius = 2,
        spawn_max_radius = 5
      ...
      {
        decorative = "lunaris_dark-mud-decal",
        spawn_min = 0,
        spawn_max = 3,
        spawn_min_radius = 2,
        spawn_max_radius = 6
      ...
      {
        decorative = "lunaris_enemy-decal",
        spawn_min = 3,
        spawn_max = 5,
        spawn_min_radius = 2,
        spawn_max_radius = 7
      ...
      {
        decorative = "lunaris_enemy-decal-transparent",
        spawn_min = 4,
        spawn_max = 20,
        spawn_min_radius = 2,
        spawn_max_radius = 14,
      ...
      {
        decorative = "lunaris_muddy-stump",
        spawn_min = 2,
        spawn_max = 5,
        spawn_min_radius = 3,
        spawn_max_radius = 6
  ...
  {
    type = "corpse",
    name = "lunaris_biter-spawner-corpse",
    hidden_in_factoriopedia = true,
  ...
  },
  {
    ...
    corpse = "lunaris_medium-biter-corpse",
...

  {
    ...
    corpse = "lunaris_big-biter-corpse",
...

  {
    ...
    corpse = "lunaris_behemoth-biter-corpse",
...

  {
    ...
    {
      acid_stream_name = "lunaris_acid-stream-spitter-small",
    ...
    -- in pu
    absorptions_to_join_attack = { pollution = 4 },
    corpse = "lunaris_small-spitter-corpse",
...

  {
    ...
    {
      acid_stream_name = "lunaris_acid-stream-spitter-medium",
    ...
    corpse = "lunaris_medium-spitter-corpse",
...

  {
    ...
    {
      acid_stream_name = "lunaris_acid-stream-spitter-big",
    ...
    corpse = "lunaris_big-spitter-corpse",
...

  {
    ...
    {
      acid_stream_name = "lunaris_acid-stream-spitter-behemoth",
    ...
    corpse = "lunaris_behemoth-spitter-corpse",
  ...
  {
    type = "corpse",
    name = "lunaris_medium-biter-corpse",
  ...
  {
    type = "corpse",
    name = "lunaris_behemoth-biter-corpse",
  ...
  {
    type = "corpse",
    name = "lunaris_small-spitter-corpse",
  ...
  {
    type = "corpse",
    name = "lunaris_medium-spitter-corpse",
  ...
  {
    type = "corpse",
    name = "lunaris_big-spitter-corpse",
  ...
  {
    type = "corpse",
    name = "lunaris_behemoth-spitter-corpse",
...

  {
    ...
    damaged_trigger_effect = hit_effects.biter(),
    absorptions_per_second = { pollution = { absolute = 20, proportional = 0.01 } },
    corpse = "lunaris_spitter-spawner-corpse",
    ...
    result_units =
    {
      {"lunaris_small-biter", {{0.0, 0.3}, {0.35, 0}}},
      {"lunaris_small-spitter", {{0.25, 0.0}, {0.5, 0.3}, {0.7, 0.0}}},
      {"lunaris_medium-spitter", {{0.4, 0.0}, {0.7, 0.3}, {0.9, 0.1}}},
      {"lunaris_big-spitter", {{0.5, 0.0}, {1.0, 0.4}}},
      {"lunaris_behemoth-spitter", {{0.9, 0.0}, {1.0, 0.3}}},
    },
    -- With zero evolution the spawn rate is 6 seconds, with max evolution it is 2.5 seconds
    spawning_cooldown = {360, 150},
    spawning_radius = 10,
    ...
    -- (2018-12-07)
    autoplace = enemy_autoplace.enemy_spawner_autoplace("lunaris_enemy_autoplace_base(0, 8)"),
    call_for_help_radius = 50,
    ...
    spawn_decoration =
    {
      ...
      {
        decorative = "lunaris_lichen-decal",
        spawn_min = 1,
        spawn_max = 2,
        spawn_min_radius = 2,
        spawn_max_radius = 7
  ...
  {
    type = "corpse",
    name = "lunaris_spitter-spawner-corpse",
    hidden_in_factoriopedia = true,
    flags = {"placeable-neutral", "placeable-off-grid", "not-on-map"},
