...
enemy_autoplace = require ("prototypes.lunaris.entity.enemy-autoplace-utils")
...
function worm_corpse(name, scale, tint, order_char)
  ...
  tab.icon = "__lunaris_graphics__/graphics/icons/" .. name .. "-worm-corpse.png"
...
data:extend(
{
  {
    type = "turret",
    name = "lunaris_small-worm-turret",
    ...
    corpse = "lunaris_small-worm-corpse",
    folded_state_corpse = "lunaris_small-worm-corpse-burrowed",
  ...
  worm_corpse("lunaris_small", scale_worm_small, tint_worm_small,"a"),
  worm_corpse_burrowed("lunaris_small", scale_worm_small, tint_worm_small,"a"),
  {
...
data:extend(
{
  {
    type = "turret",
    name = "lunaris_medium-worm-turret",
    ...
    rotation_speed = 1,
    corpse = "lunaris_medium-worm-corpse",
    folded_state_corpse = "lunaris_medium-worm-corpse-burrowed",
...

  {
    ...
    rotation_speed = 1,
    corpse = "lunaris_big-worm-corpse",
    folded_state_corpse = "lunaris_big-worm-corpse-burrowed",
  ...
  {
    type = "turret",
    name = "lunaris_behemoth-worm-turret",
    ...
    shooting_cursor_size = 4,
    rotation_speed = 1,
    corpse = "lunaris_behemoth-worm-corpse",
    folded_state_corpse = "lunaris_behemoth-worm-corpse-burrowed",
  ...
  worm_corpse("lunaris_medium", scale_worm_medium, tint_worm_medium,"b"),
  worm_corpse_burrowed("lunaris_medium", scale_worm_medium, tint_worm_medium,"b"),

  worm_corpse("lunaris_big", scale_worm_big, tint_worm_big,"c"),
  worm_corpse_burrowed("lunaris_big", scale_worm_big, tint_worm_big,"c"),

  worm_corpse("lunaris_behemoth", scale_worm_behemoth, tint_worm_behemoth,"d"),
  worm_corpse_burrowed("lunaris_behemoth", scale_worm_behemoth, tint_worm_behemoth,"d")
}
)
