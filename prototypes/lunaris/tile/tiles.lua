...
local tile_sounds = require("__lunar_legacy__/prototypes/lunaris/tile/tile-sounds")
local tile_trigger_effects = require("prototypes.lunaris.tile.tile-trigger-effects")
local tile_pollution = require("__lunar_legacy__/prototypes/lunaris/tile/tile-pollution-values")
local tile_collision_masks = require("__lunar_legacy__/prototypes/lunaris/tile/tile-collision-masks")

local tile_graphics = require("__lunar_legacy__/prototypes/lunaris/tile/tile-graphics")
...
lunar_legacy_tiles_util = lunar_legacy_tiles_util or {}
...
table.insert(water_tile_type_names, "lunaris_water")
table.insert(water_tile_type_names, "lunaris_deepwater")
table.insert(water_tile_type_names, "water-green")
table.insert(water_tile_type_names, "lunaris_deepwater-green")
...
lunar_legacy_tiles_util.ground_to_out_of_map_transition = ground_to_out_of_map_transition
lunar_legacy_tiles_util.concrete_to_out_of_map_transition = concrete_to_out_of_map_transition
lunar_legacy_tiles_util.stone_path_to_out_of_map_transition = stone_path_to_out_of_map_transition
...
data:extend
{
  ...
  },
  {
    ...
    particle_tints = tile_graphics.lunaris_deepwater_particle_tints,
    layer_group = "water",
    layer = 3,
    variants =
    {
    ...
    --transitions = { lunaris_deepwater_out_of_map_transition },
    --transitions_between_transitions = lunaris_deepwater_transitions_between_transitions,
    allowed_neighbors = { "lunaris_water" },
    map_color={38, 64, 73},
  ...
  {
    name = "lunaris_deepwater-green",
    type = "tile",
    order = "a[water]-d[lunaris_deepwater-green]",
    subgroup = "lunaris-tiles",
    transition_merges_with_tile = "lunaris_water",
    collision_mask = tile_collision_masks.water(),
    fluid = "water",
  ...
  {
    name = "lunaris_water-shallow",
    type = "tile",
    order = "a[water]-e[lunaris_water-shallow]",
    subgroup = "lunaris-tiles",
  ...
  },
  {
    ...
    effect = "water",
    effect_color = { 100 * 0.25, 255 * 0.25, 241 * 0.25, 255 * 0.125 },
    effect_color_secondary = {r = 0.031, g = 0.129, b = 0.031, a = 0.361},
...
-----------//////////////////////////////////////////////////////////////lunaris_sand-1
  {
    name = "lunaris_sand-1",
    type = "tile",
    order = "b[natural]-c[sand]-a[lunaris_sand-1]",
    subgroup = "lunaris-tiles",
    collision_mask = tile_collision_masks.ground(),
...
-----------//////////////////////////////////////////////////////////////SAND-2
  {
    ...
    factoriopedia_alternative = "lunaris_sand-1",
