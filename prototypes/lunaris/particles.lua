...
local particle_animations = require("prototypes.lunaris.particle-animations")
...
make_particle
 ...
 make_particle
  ...
  make_particle
  {
    name = "lunaris_blood-particle-lower-layer",
    life_time = 180,
    pictures = particle_animations.get_blood_particle_pictures({tint = bloodtint(), scale = 0.75}),
    shadows = particle_animations.get_blood_particle_pictures({ tint = shadowtint(), shift = util.by_pixel (1,0), scale = 0.75}),
    draw_shadow_when_on_ground = false,
  ...
  make_particle
  {
    name = "lunaris_blood-particle-small",
    life_time = 180,
  ...
  make_particle
  {
    name = "lunaris_blood-particle-lower-layer-small",
    life_time = 180,
    pictures = particle_animations.get_blood_particle_pictures({tint = bloodtint(), scale = 0.5}),
    shadows = particle_animations.get_blood_particle_pictures({ tint = shadowtint(), shift = util.by_pixel (1,0), scale = 0.75}),
    draw_shadow_when_on_ground = false,
  ...
  make_particle
  {
    name = "lunaris_blood-particle-carpet-small",
    life_time = 180,
    pictures = particle_animations.get_blood_particle_pictures({tint = bloodtint(), scale = 0.5}),
    shadows = particle_animations.get_blood_particle_pictures({ tint = shadowtint(), shift = util.by_pixel (1,0), scale = 0.75}),
    draw_shadow_when_on_ground = false,
...

  {
    ...
    order = "d-b",
    subgroup = "particles",
    particle = "lunaris_blood-particle",
    time_to_live = 10,
