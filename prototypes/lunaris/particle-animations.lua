...
particle_animations.get_water_particle_pictures = function(options)
  ...
  return
  {
    sheet =
    {
      filename = "__lunaris_graphics__/graphics/particle/blood-particle/water-particle.png",
      line_length = 12,
      width = 16,
      height = 16,
      frame_count = 12,
...
particle_animations.get_blood_particle_pictures = function(options)
  ...
  return
  {
    sheet =
    {
      filename = "__lunaris_graphics__/graphics/particle/blood-particle/blood-particle.png",
      line_length = 12,
      width = 32,
      height = 24,
      frame_count = 12,
