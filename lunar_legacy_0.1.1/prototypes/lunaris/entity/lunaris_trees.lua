...
local simulations = require("__lunar_legacy__.prototypes.lunaris.factoriopedia-simulations")
...
local tree_autoplace = {
  ['tree-01'] = {
    control = "lunaris_trees",
    order = "a[lunaris_tree]-b[forest]-a[wet]-c[cold]",
